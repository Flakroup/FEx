...
public interface ICollectionChangeNotifier : INotifyCollectionChanged, INotifyPropertyChanged
{
    ...
    void OnCollectionChanged(object sender, string[] propertyChangedArgs, NotifyCollectionChangedAction changeAction, object changedItem, object oldItem, int? index, int? oldIndex);
