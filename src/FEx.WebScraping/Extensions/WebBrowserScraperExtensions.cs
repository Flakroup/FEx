...
public static class WebBrowserScraperExtensions
{
    ...
    public static Task LoadAsync(this IWebBrowserScraper scraper, Uri pageLink,
    ...
    public static Task<T> LoadAsync<T>(this IWebBrowserScraper scraper, Uri pageLink,
    ...
    public static T Load<T>(this IWebBrowserScraper scraper, Uri pageLink,
                            Func<Uri, HtmlWeb, HtmlDocument, T> action) =>
