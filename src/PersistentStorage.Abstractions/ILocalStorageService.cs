...
public interface ILocalStorageService : IFileLocalStorageService
{
    ...
    /// <returns></returns>
    IReadOnlyList<T> GetAll<T>(Expression<Func<T, bool>> predicate = null) where T : ICacheableItem;
    ...
    /// <param name="predicate">Predicate</param>
    /// <returns></returns>
    bool DeleteAll<T>(Expression<Func<T, bool>> predicate = null) where T : ICacheableItem;
