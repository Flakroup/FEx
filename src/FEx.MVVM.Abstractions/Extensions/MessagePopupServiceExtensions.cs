...
public static class MessagePopupServiceExtensions
{
    ...
    public static Task<MessageResult> ShowMessageAsync(this IMessagePopupService service,
                                                       string txt,
                                                       string caption,
    ...
    public static MessageResult ShowMessage(this IMessagePopupService service,
                                            string txt,
                                            string caption,
                                            MessageIcon messageBoxImage) =>
        service.ShowMessage(txt,
