...
public class GridView : ListView
{
    ...
    {
        get => (bool)GetValue(IsWrappingKeyboardNavigationEnabledProperty);
        set => SetValue(IsWrappingKeyboardNavigationEnabledProperty, value);
    }
    ...
    private void GridView_PreviewKeyDown(object sender, KeyEventArgs e)
    {
        ...
        if (targetIndex >= 0
            && targetIndex < gridView.Items.Count)
