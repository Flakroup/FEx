...
public class FExBehaviorSubject<T> : FExSubject<T>, IFExBehaviorSubject<T>
{
    ...
    ///     <para>
    ///     After <see cref="IObserver{T}.OnError(System.Exception)" /> is called, <see cref="Value" /> always throws the specified
    ///     exception.
    ///     </para>
    ...
    ///     <see cref="IObserver{T}.OnNext(T)" /> or <see cref="IObserver{T}.OnError(System.Exception)" /> are being invoked
    ///     concurrently.
