...
public static class CachedImageStorageExtensions
{
    ...
    public static Task<IIndexEntryBase>
        PrepareCacheAndGetEntryBaseAsync(this ICachedImageStorage storage, Uri fileUrl) =>
    ...
    public static Task CacheAllAsync(this ICachedImageStorage storage) => storage.CacheAllAsync(null);
}