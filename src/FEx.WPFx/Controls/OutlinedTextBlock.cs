...
public class OutlinedTextBlock : FrameworkElement
{
    ...
    public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.Register(nameof(TextWrapping),
        typeof(TextWrapping),
        typeof(OutlinedTextBlock),
    ...
    protected override Size MeasureOverride(Size availableSize)
    {
        ...
        _formattedText ??= new(Text ?? string.Empty,
            CultureInfo.CurrentUICulture,
            FlowDirection,
            new(FontFamily, FontStyle, FontWeight, FontStretches.Normal),
            FontSize,
            Brushes.Black,
            GetDIP());
        ...
        return new(Math.Ceiling(_formattedText.Width), Math.Ceiling(_formattedText.Height));
    }
    ...
    private void UpdateFormattedText()
    {
        ...
        _formattedText.MaxLineCount = TextWrapping == TextWrapping.NoWrap
            ? 1
            : int.MaxValue;
