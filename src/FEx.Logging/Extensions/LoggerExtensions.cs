...
public static class LoggerExtensions
{
    ...
    private static LoggerConfiguration
        ...
        logFilePath, outputTemplate: DefaultFileOutputTemplate, fileSizeLimitBytes: (int)FileLengthConverter.ConvertFileLength(100, LengthType.Megabytes, LengthType.Bytes),
