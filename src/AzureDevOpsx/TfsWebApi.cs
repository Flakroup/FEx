...
public static class TfsWebApi
{
    static TfsWebApi()
    {
        WebServices.StatusCodes = new()
        {
            ...
            {
                409,
                "There's a conflict between the request and the state of the data on the server. For example, if you attempt to submit a pull request and there is already a pull request for the commits."
            }
        };
    }
}